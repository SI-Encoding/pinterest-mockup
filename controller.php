...
if (isset($_POST['update']))
{
	...
	//     $update_pass = "UPDATE users SET code = $code, username = $name, password = '$encpass', email = $email
	//                     WHERE email = '$email'";
	//     $data_check = mysqli_query($con, $update_pass);
	

	// }else{
	//     $errors['login-error'] = "Failed, you are not logged in!";
	// }
